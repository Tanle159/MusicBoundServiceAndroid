...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.uiplayermusic);

        final Button btOn = (Button) findViewById(R.id.btnPlay);
        final ImageView btOff = (ImageView) findViewById(R.id.pause);
        final ImageView btFast = (ImageView) findViewById(R.id.next);
